 ...
 */
 ...
 int main(int argc, char **argv)
 {
     ...
     /* Get KEYS_PATH environment value. set to CST_PATH if unavailable. */
     g_keys_path = getenv("KEYS_PATH");
     if(!g_keys_path){
         printf("INFO: Unspecified KEYS_PATH. Using CST_PATH to locate keys.\n");
         g_keys_path = getenv("CST_PATH");
     }
